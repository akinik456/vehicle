...
abstract class AppLocalizations {
  ...
  /// No description provided for @pleaseactivatewebaccess.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @signintoyourfleetdashboard.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @vehicleFleet.
  ///
  /// In en, this message translates to:
  /// **'Vehicle Fleet'**
  String get vehicleFleet;

  /// No description provided for @vehicleWeb.
  ///
  /// In en, this message translates to:
  /// **'Vehicle Web'**
  String get vehicleWeb;
  ...
  /// No description provided for @webaccessisnotactive.
  ///
  /// In en, this message translates to:
  /// **'Web access is not active.'**
  String get webaccessisnotactive;
}
